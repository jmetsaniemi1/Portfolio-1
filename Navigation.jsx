...
function Navigation({ onProjectsClick, hideBackgroundAndThemeSwitch }) {
  ...
  return (
    <div className="navigation-wrapper">
      {/* Taustavideot ja teemanvaihtonappi vain jos ei hideBackgroundAndThemeSwitch */}
      {!hideBackgroundAndThemeSwitch && (
        <>
          <video
  ...
  <ul>
    ...
    <li>
      <a href="#CONTACT">CONTACT</a>
          ...
          <li>
  <button id="open-schoolblog" onClick={() => { navigate('/schoolblog'); setIsMenuOpen(false); }}>
    SCHOOL BLOG
  </button>
</li>
